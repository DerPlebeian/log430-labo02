...
from queries.read_order import get_orders_from_mysql, get_orders_from_redis, get_highest_spending_users, get_highest_spending_products
...
def get_report_best_sellers():
    ...
    return get_highest_spending_products()
